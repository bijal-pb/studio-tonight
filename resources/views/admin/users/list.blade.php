    ...
    $(document).ready(function(){
        ...
        var table =  $('#user-table').DataTable(
                {
                    ...
                    ajax: {
                        ...
                        data: {
                            type: function() { return $('#typeFilter').val() },
                        }
                    },  
                    // ajax: "{{ route('admin.users.list') }}",
                    columns: [
                        {data: 'id', name: 'Id'},
                        {data: 'avatar', name: 'Profile' ,orderable: false, searchable: false},
                        {data: 'name', name: 'Name'},
        ...
        $(document).on('click', '.active', function(){
            ...
            Swal.fire(
                {
                    title: "Are you sure?",
                    text: status == 1 ? "All the studios of this user will be deactivated!" : "All the studios of this user will be activated!",
                    type: "warning",
