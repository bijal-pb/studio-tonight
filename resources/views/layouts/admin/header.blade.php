...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="{{ URL::asset('admin_assets/css/formplugins/summernote/summernote.css')}}">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
        <link rel="stylesheet" media="screen, print" href="{{ URL::asset('admin_assets/css/formplugins/bootstrap-datepicker/bootstrap-datepicker.css')}}">
    ...
    <body class="mod-bg-1 ">
        ...
        <script>
            ...
            var classHolder = document.getElementsByTagName("BODY")[0],
                ...
                if(themeURL == ''){
                    var themeSet = {};
                    themeSet.themeURL = '{{ config('app.url') }}'+'/admin_assets/css/themes/cust-theme-14.css';
                    themeSet.themeOptions = 'mod-bg-4 nav-function-top';
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="{{ Auth::user()->avatar }}" class="profile-image rounded-circle" alt="admin">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="{{ Auth::user()->avatar }}" class="rounded-circle profile-image" alt="admin">
                                            </span>
